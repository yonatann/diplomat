defmodule Diplomat.KeyUtilsTest do
  ...
  test "KeyUtils.urlsafe" do
    app = "testbed-test"
    key_with_id1 = %Key{kind: "User", id: 1, dataset_id: app}
    key_with_id2 = %Key{kind: "User", id: 2, dataset_id: app}
    key_with_name = %Key{kind: "User", name: "hello", dataset_id: app}
    key_with_parent = %Key{kind: "User", id: 3, parent: key_with_id2, dataset_id: app}
  ...
  test "KeyUtils.from_urlsafe" do
    ...
    assert key.dataset_id == "testbed-test"
    assert key.id == 3
